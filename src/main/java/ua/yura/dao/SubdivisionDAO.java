...
public class SubdivisionDAO {
    ...
    public SubdivisionDAO(List<Subdivision> mcdList, List<Subdivision> pumaList, List<Subdivision> uclList) {
        ...
        mcdList.add(new Subdivision(UUID.randomUUID(), "МакДональдз - ЦУМ", 48, "+38(050) 463-34-01", "Дніпро", "пр.Д Яворницького (пр.Карла Маркса), 52-A"));
        mcdList.add(new Subdivision(UUID.randomUUID(), "МакДональдз - 95 квартал", 31, "+38(050) 463-91-16", "Кривий ріг", "пр. Гагаріна, 2"));
        mcdList.add(new Subdivision(UUID.randomUUID(), "МакДональдз - Глобал Житомир", 62, "+38(050) 386-71-51", "Житомир", "вул. Київська, 77"));
        mcdList.add(new Subdivision(UUID.randomUUID(), "МакДональдз - Смілянська", 14, "+3(050) 463-91-20", "Черкаси", "вул. Смілянська, 31"));
        mcdList.add(new Subdivision(UUID.randomUUID(), "МакДональдз - Стрийський", 100, "+38(095) 283-81-37", "Сокільники", "вул. Стрійська, 30-А"));
        mcdList.add(new Subdivision(UUID.randomUUID(), "МакДональдз - Дружба", 37, "+38(050) 463-44-55", "Львів", "просп. Чорновола, 12"));
        mcdList.add(new Subdivision(UUID.randomUUID(), "МакДональдз - Перспективна", 130, "+38(050) 923 45 30", "Кропивницький", "вул. Велика Перспективна, 45/9"));
        ...
        mcdList.add(new Subdivision(UUID.randomUUID(), "МакДональдз - Опера", 57, "+38(050) 463-16-82", "Львів", "пр. Совбоди, 35"));
